...
const { esAdmin } = require("Helpers/eAdmin");
...
router.get("/postagem/:slug", esAdmin, (req, res) => {
...
router.get("/admin/categorias/edit/:id",esAdmin, (req, res) => {
...
router.post("/admin/categorias/edit",esAdmin, (req, res) => {
